    ...
    <>
      ...
      <div className={`content absolute inset-0 ${isLoaded ? "loaded" : ""} overflow-y-auto pt-12`}>
        <div className="min-h-screen bg-gradient-to-b from-white via-[#D1FAE5] to-[#C4EDE0]">
            ...
            <div className="flex h-full">
              ...
              <div className="flex-1 pl-8 md:pl-16 flex items-center">
                <div className="max-w-2xl">
                  <h1 className="font-manrope font-bold text-6xl md:text-7xl text-[#065f46] leading-relaxed mb-8">
          ...
          {/* Footer */}
          <footer className="relative px-8 md:px-16 py-12 bg-white/0 backdrop-blur-sm border-t border-[#34D399]/10 overflow-hidden">
            {/* Background Images */}
            ...
            <div className="max-w-7xl mx-auto relative z-10">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="space-y-4">
                  <img src={logo} alt="Neo Logo" className="w-12 h-12 hover:scale-110 transition-transform duration-300" />
